...
public class MessageRepository(DataContext context, IMapper mapper) : IMessagRepository
{
    ...
    public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
    {
        ...
        {
            //if the container  is the inbox
            "Inbox" => query.Where(x => x.Recipient.UserName == messageParams.Username
                    && x.RecipientDeleted == false),
            "QutBox" => query.Where(x => x.Sender.UserName == messageParams.Username
